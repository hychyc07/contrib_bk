...
bool EdisonSegmModule::configure(yarp::os::ResourceFinder &rf)
{
    ...
    moduleName          = rf.check("name",Value("edisonSegmenter"), "module name (string)").asString();
    ...
    string portName = "/" + moduleName + "/" + "rawImg:i";
	_imgPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "conf";
	_configPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "filtImg:o";
	_filtPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "labeledImg:o";
	_labelPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "viewImg:o";
	_viewPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "rawImg:o";
	_rawPort.open(portName.c_str());
    portName.clear();
    portName = "/" + moduleName + "/" + "debugImg:o";
	_labelViewPort.open(portName.c_str());
	//attach(_configPort);

...
//#include <iCub/vislab/EyeTableProjection.h>			// not found...
//#include <iCub/affActionPrimitives.h>				// not found...

#include "action/actionPrimitives.h"
#include "eye2world/eyeTableProjection.h"
...
private:
	...
	// Helper methods by Joao Costa
	void isGrasping(string& hand, bool& returnvalue);
	std::deque<std::string> stringSplit(std::string &source, char *delimiter = " ", bool keepEmpty = false);
	//Helper variable by Afonso Gonçalves
	int mode;

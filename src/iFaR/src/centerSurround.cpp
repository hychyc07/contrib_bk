...
void CenterSurround::proc_im_32f(IplImage* im_32f, IplImage* output8u)
{
    ...
    printf("subtractions (ABSDIFF) to make DOG pyramid first \n");
    ...
    printf("subtractions (ABSDIFF) to make DOG pyramid second \n");
  	//2nd neighbours:
    ...
    printf("trying conversion \n");

    cvConvertScale(cs_tot_32f,output8u,255,0);
    printf("success in  CenterSurround::proc_im_32f");
}

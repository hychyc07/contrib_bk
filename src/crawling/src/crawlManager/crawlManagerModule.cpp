...
bool crawlManagerModule::updateModule()
{
    ...
    cout << "curr spd: " << speed <<  " curr dir: "<< direction <<endl;
...
bool crawlManagerModule::configure(yarp::os::ResourceFinder &rf)
{
	...
	*/
    ...
    {                      
        ...
        sprintf(tmp1,"/crawlGenerator/%s/parameters/in",part_names[i].c_str());
        ...
        if(query.isValid())
        {
            ...
            sprintf(tmp2, "/crawlGenerator/%s/status_for_manager/out", part_names[i].c_str());

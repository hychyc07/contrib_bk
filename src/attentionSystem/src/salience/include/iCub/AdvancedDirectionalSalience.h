...
#ifndef ICUB_AdvancedDirectionalSalience_INC
#define ICUB_AdvancedDirectionalSalience_INC
...
namespace iCub {
    namespace contrib {
        class AdvancedDirectionalSalience;
    }
}
 ...
 */
class iCub::contrib::AdvancedDirectionalSalience : public Salience,
...
private:
    ...
    float **_conspDPlu; // 2d array of conspicuity factors for the _imgDPlu array
...
public:
    AdvancedDirectionalSalience();
    virtual ~AdvancedDirectionalSalience();
    ...
    // AdvancedDirectionalSalienceControls

% now 8 april 2010 14:34, i know why this doesnt work well, because it
% generates pz accodering to time, but it should be the kinematics
% typology, not time.
% store phase info

%%%%%%%%%%%%%%%%%%%%%%%
Atilt=0.002; limit = 1e10;   %A=0.5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                 Pz(n+1) = hip_height + A*( sin(w*( t-0.25*Period)) + 1) ;

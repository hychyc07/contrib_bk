 ...
 * Contrib: Roland Philippsen (author of original WBC library and examples)
...
#ifndef WBC_TUTORIAL_SIMULATOR7_HPP
#define WBC_TUTORIAL_SIMULATOR7_HPP
...
using namespace yarp::os; // ok but do not use ::sig because of Vector collision
...
#endif // WBC_TUTORIAL_SIMULATOR7_HPP

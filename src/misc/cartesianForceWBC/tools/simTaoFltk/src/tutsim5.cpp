...
static char const * win_title("Stanford WBC with 5DOF iCub model");
...
std::cerr << "h[1]: " << tree.info[id2].node->frameGlobal()->translation()[0] << " " << tree.info[id2].node->frameGlobal()->translation()[1] << " " << tree.info[id2].node->frameGlobal()->translation()[2] << "\n";
std::cerr << "h[2]: " << tree.info[id3].node->frameGlobal()->translation()[0] << " " << tree.info[id3].node->frameGlobal()->translation()[1] << " " << tree.info[id3].node->frameGlobal()->translation()[2] << "\n";
std::cerr << "h[3]: " << tree.info[id4].node->frameGlobal()->translation()[0] << " " << tree.info[id4].node->frameGlobal()->translation()[1] << " " << tree.info[id4].node->frameGlobal()->translation()[2] << "\n";
std::cerr << "h[4]: " << tree.info[id5].node->frameGlobal()->translation()[0] << " " << tree.info[id5].node->frameGlobal()->translation()[1] << " " << tree.info[id5].node->frameGlobal()->translation()[2] << "\n";
#endif
    deVector3 globpoint;
		...
		double x0, double y0, double scale)
{
  ...
  locframe.translation()[2] = -1.0;
  deFrame globframe;
  globframe.multiply(*(scratch_tree->info[id5].node->frameGlobal()), locframe);

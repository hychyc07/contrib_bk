...
#ifndef _REMEMBEREDX_THREAD_H_
#define _REMEMBEREDX_THREAD_H_
...
class rememberedxThread : public yarp::os::RateThread {
private:
    ...
    yarp::os::Bottle* bottleReceiving[5];
    yarp::os::Semaphore* mute[5];
    double pCue[20][50]; 
...
public:
    ...
    */
    rememberedxThread(std::string robotname,std::string configFile);
    ...
    */
    void setSharingBottle(yarp::os::Bottle *bottleIn[]);

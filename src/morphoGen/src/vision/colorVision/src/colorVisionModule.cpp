...
bool colorVisionModule::configure(yarp::os::ResourceFinder &rf) {
...
bool colorVisionModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool colorVisionModule::close() {
    handlerPort.close();
    /* stop the thread */
...
bool colorVisionModule::respond(const Bottle& command, Bottle& reply) 
{
...
bool colorVisionModule::updateModule()
{
    return true;
}

double colorVisionModule::getPeriod()
{

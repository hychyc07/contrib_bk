...
#ifndef _OBSERVER_MODULE_H_
#define _OBSERVER_MODULE_H_
...
class ObserverModule:public yarp::os::RFModule {
    ...
    /*  */
    ObserverThread *rThread;             // pointer to a new thread to be created and started in configure() and stopped in close()

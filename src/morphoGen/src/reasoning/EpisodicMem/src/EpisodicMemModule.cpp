...
bool EpisodicMemModule::configure(yarp::os::ResourceFinder &rf) {
...
*/
    ...
    rThread = new EpisodicMemThread(robotName, configFile);
...
bool EpisodicMemModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool EpisodicMemModule::close() {
    handlerPort.close();
    /* stop the thread */
...
bool EpisodicMemModule::respond(const Bottle& command, Bottle& reply) 
{
...
bool EpisodicMemModule::updateModule()
{
    return true;
}

double EpisodicMemModule::getPeriod()
{

...
#ifndef _OPC_MODULE_H_
#define _OPC_MODULE_H_
...
class OPCModule:public yarp::os::RFModule {
    ...
    /*  */
    OPCThread *rThread;             // pointer to a new thread to be created and started in configure() and stopped in close()

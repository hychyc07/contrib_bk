...
/**
 * @file colorQuantizatorModule.h
 * @brief Simple module as tutorial.
 */

#ifndef _COLOR_QUANTIZATOR_MODULE_H_
#define _COLOR_QUANTIZATOR_MODULE_H_



/** 
 *
 * \defgroup icub_colorQuantizator colorQuantizator
 ...
 * (they can also be specified as command-line parameters if you wish so). 
...
class colorQuantizatorModule:public yarp::os::RFModule {

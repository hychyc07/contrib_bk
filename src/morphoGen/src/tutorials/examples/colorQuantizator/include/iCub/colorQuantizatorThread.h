...
class colorQuantizatorThread : public yarp::os::Thread {
private:
...
public:
    ...
    * constructor default
    */
    colorQuantizatorThread();

    /**
    * constructor 
    * @param robotname name of the robot
    */
    colorQuantizatorThread(std::string robotname,std::string configFile);
...
#endif  //_COLOR_QUANTIZATOR_THREAD_H_

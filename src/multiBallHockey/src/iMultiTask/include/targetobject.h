...
public:
	...
	std::vector<double> speedVec; // to compute mean speed
	std::vector<double> speedVecx; // to compute mean speed
	std::vector<double> speedVecy; // to compute mean speed
	
	double meanSpeed, meanSpeedx, meanSpeedy;

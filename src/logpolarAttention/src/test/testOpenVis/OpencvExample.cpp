...
{
  //read input images
  std::cout<<"reading of the test Stereo images"<<std::endl;
  IplImage*img1 = 0; img1 = cvLoadImage(imgfilename1);
  IplImage*img2 = 0; img2 = cvLoadImage(imgfilename2);
...
int main()
{
  std::cout<<"starting the test of Stereo Matching"<<std::endl;
  testStereo("/usr/local/src/robot/iCub/contrib/src/logpolarAttention/src/test/testOpenVis/tsukuba1color.png", "/usr/local/src/robot/iCub/contrib/src/logpolarAttention/src/test/testOpenVis/tsukuba2color.png", 5, 15);
  std::cout<<"starting the test of Optical Flow"<<std::endl;
  testOpticalFlow("/usr/local/src/robot/iCub/contrib/src/logpolarAttention/src/test/testOpenVis/car1.png", "/usr/local/src/robot/iCub/contrib/src/logpolarAttention/src/test/testOpenVis/car0.png", 0, 18, -3, 0);

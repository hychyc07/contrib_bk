...
/**
 * @file inputFeederModule.cpp
 * @brief Implementation of the inputFeederModule (see header file).
 */

#include <iCub/inputFeederModule.h>
...
bool inputFeederModule::configure(yarp::os::ResourceFinder &rf) {
    ...
    */
    ...
    ifThread=new inputFeederThread();
...
bool inputFeederModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool inputFeederModule::close() {
    handlerPort.close();
    /* stop the thread */
    return true;
}

bool inputFeederModule::respond(const Bottle& command, Bottle& reply) {
...
bool inputFeederModule::updateModule() {
    return true;
}

double inputFeederModule::getPeriod() {

...
/**
 * @file inputFeederThread.h
 * @brief Definition of a thread that read a file image, sends it to the port for every time delay constant
 * (see inputFeederModule.h).
 */

#ifndef _INPUT_FEEDER_THREAD_H_
#define _INPUT_FEEDER_THREAD_H_
...
class inputFeederThread : public yarp::os::RateThread {
private:

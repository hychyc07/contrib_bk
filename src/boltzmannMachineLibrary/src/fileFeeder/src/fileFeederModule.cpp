...
/**
 * @file fileFeederModule.cpp
 * @brief Implementation of the fileFeederModule (see header file).
 */

#include <iCub/fileFeederModule.h>
...
bool fileFeederModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool fileFeederModule::close() {
    handlerPort.close();
    /* stop the thread */
    return true;
}

bool fileFeederModule::respond(const Bottle& command, Bottle& reply) {
...
bool fileFeederModule::updateModule() {
    return true;
}

double fileFeederModule::getPeriod() {

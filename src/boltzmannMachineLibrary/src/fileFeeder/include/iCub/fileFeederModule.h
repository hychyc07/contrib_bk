...
/**
 * @file fileFeederModule.h
 * @brief A module that controls the process of this application
 */

#ifndef _FILE_FEEDER_MODULE_H_
#define _FILE_FEEDER_MODULE_H_
...
class fileFeederModule:public yarp::os::RFModule {
    ...
    fileFeederThread* ffThread;                // ratethread in charge of sending images
...
#endif // __FILE_FEEDER_MODULE_H__

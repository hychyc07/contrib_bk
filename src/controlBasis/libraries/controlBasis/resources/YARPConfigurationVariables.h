...
namespace CB {
    ...
    public:
        ...
        /**
         * Sets a joint in the postion control device
         **/
        void setJointPositionDirect(int j, double v);

        /**
         * Sets a joint in the postion control device
         **/
        void getJointPositionsDirect(yarp::sig::Vector &v);

        /**
         * Sets a joint reference speed
         **/
        void setJointReferenceSpeed(int j, double v);

        /**
         * Sets a joint velocity
         **/
        void setJointVelocityDirect(int j, double v);

        /**
         * Sets a joint velocity
         **/
        void setJointVelocityDirect(yarp::sig::Vector v);

        /**
         * Gets the joint accelerations
         **/
        void getJointAccelerationsDirect(yarp::sig::Vector &v);

        /**
         * returns the IEncoder interface
         **/
        yarp::dev::IEncoders * getEncoderInterface() { return enc; }

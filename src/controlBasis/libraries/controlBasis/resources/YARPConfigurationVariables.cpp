...
void CB::YARPConfigurationVariables::setJointPositionDirect(int j, double v) {
    if(pos==NULL) {
       cout << "IPositionControl pointer is NULL!" << endl;        
    } else {
        pos->positionMove(j, v*TODEG);            
    }
}

void CB::YARPConfigurationVariables::getJointPositionsDirect(Vector &v) {
    if(enc==NULL) {
        cout << "IEncoders pointer is NULL!" << endl;        
    } else {
...
void CB::YARPConfigurationVariables::setJointReferenceSpeed(int j, double v) {
    if(pos==NULL) {
        cout << "IPositionControl pointer is NULL!" << endl;        
    } else {
        pos->setRefSpeed(j,v);
...
void CB::YARPConfigurationVariables::setJointVelocityDirect(int j, double v) {
    if(vel==NULL) {
        cout << "IVelocityControl pointer is NULL!" << endl;        
    } else {
        vel->velocityMove(j, v);            
    }
}
...
bool CB::YARPConfigurationVariables::connectToDevice() {
    ...
    if(vel==NULL || pos==NULL || enc==NULL || lim==NULL) {
        cout << "control pointers are NULL!" << endl;
        dd->close();
    }

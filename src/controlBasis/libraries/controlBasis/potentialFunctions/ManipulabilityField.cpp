...
bool CB::ManipulabilityField::connectToInputs() {
    ...
    sprintf(ch,"%d", randomID);
    std::string randomIDstr(ch);
    ...
    string configNameIn = "/cb/configuration/manipulability_pf" + tmp + "/" + randomIDstr + "/data:i";
    string paramsNameIn = "/cb/configuration/manipulability_pf" + tmp + "/" + randomIDstr + "/params:i";

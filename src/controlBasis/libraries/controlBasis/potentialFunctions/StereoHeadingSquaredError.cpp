...
bool CB::StereoHeadingSquaredError::connectToInputs() {
    ...
    string posCurNameIn = "/cb/stereoheading/squared_error_pf" + tmp0 + "/" + randomIDstr  + "/cur/data:i";
    string posRefNameIn = "/cb/stereoheading/squared_error_pf" + tmp1 + "/" + randomIDstr  + "/ref/data:i";

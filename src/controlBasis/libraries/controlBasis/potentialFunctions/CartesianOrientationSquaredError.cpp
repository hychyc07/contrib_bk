...
bool CB::CartesianOrientationSquaredError::connectToInputs() {
    ...
    string posCurNameIn = "/cb/cartesianorientation/squared_error_pf" + tmp0 + "/" + randomIDstr + "/cur/data:i";
    string posRefNameIn = "/cb/cartesianorientation/squared_error_pf" + tmp1 + "/" + randomIDstr + "/ref/data:i";

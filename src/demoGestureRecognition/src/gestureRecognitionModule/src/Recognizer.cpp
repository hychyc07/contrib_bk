...
string path1="C:/Users/Utente/Desktop/dataKinect/filteredScores.txt";
string path2="C:/Users/Utente/Desktop/dataKinect/meanVariance.txt";
void Recognizer::setFilter(const Vector& num, const Vector& den)
{
    this->num=num;
    this->den=den;
}
...
int Recognizer::recognize(const Vector& u, int& start, int& end)
{
    ...
    Vector out=u;//filter->filt(u);
    //saveFilteredScores(out,path1);

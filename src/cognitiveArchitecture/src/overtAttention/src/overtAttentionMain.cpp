...
int main(int argc, char *argv[]) {
    ...
    OvertAttention module;

    /* prepare and configure the resource finder */

    ResourceFinder rf;
    rf.setVerbose(true);
    rf.setDefaultConfigFile("overtAttention.ini");  
    rf.setDefaultContext("overtAttention/conf");  // the default path will now be $ICUB_ROOT/app/overtAttention/conf              

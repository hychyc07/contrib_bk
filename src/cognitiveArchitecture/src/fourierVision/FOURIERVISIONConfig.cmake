...
SET(LIB_TARGET "fourierVision")   # name used in ADD_LIBRARY(...)
SET(LIB_PKG "FOURIERVISION")      # name you want in FIND_PACKAGE(...)
...
IF (NESTED_BUILD)
  ...
  #MESSAGE(STATUS "Nested Build: Using ${LIB_PKG}_LIBRARIES")
...
ELSE (NESTED_BUILD)
  ...
  #MESSAGE(STATUS "Distributed Build: Using ${LIB_PKG}_LIBRARIES")
  ...
  IF (NOT ${LIB_PKG}_LIBRARIES)
    ...
    #MESSAGE(STATUS "Distributed Build: Using ${LIB_PKG}_LIBRARIES_RELEASE")
    #MESSAGE(STATUS "Distributed Build: Using ${LIB_PKG}_LIBRARIES_DEBUG")

 ...
 *
 */
class Control_GazeModule : public yarp::os::RFModule,
                           public IControlGazeControls {
...
private:
	...
	*/
	yarp::dev::PolyDriver		 ddHead;
    yarp::dev::PolyDriver		 ddTorso;
	yarp::dev::IPositionControl	*ipos;
	yarp::dev::IVelocityControl	*ivel;
	yarp::dev::IEncoders		*ienc, *iencTorso;
...
protected: 
	...
	void initEyeKinematics(Vector &maxL, Vector &minL)
	{
		...
		for(int i = 3; i < 8; i++)
			head.SetJointLimits(i-3,(M_PI/180.0)*minL(i),(M_PI/180.0)*maxL(i));
	};

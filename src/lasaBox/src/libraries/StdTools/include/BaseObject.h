...
/**
 *
\defgroup icub_StdTools StdTools
@ingroup icub_lasaBox_libraries

A library with some utility function such as home-made XML parsing, string manipulation, and timer function.
...
This file can be edited at $ICUB_ROOT/contrib/src/lasaBox/src/libraries/StdTools
**/

...
public:
    ...
    */
    ...
    inline Matrix4(const Matrix3 &matrix):TMatrix<4>(false){
        Vector3 zero;
        SetTransformation(matrix, zero);
    }
    ...
    inline Matrix4& Transformation(const Matrix3 &rotation, const Vector3 &translation){
        return SetTransformation(rotation, translation);
    }
    /// Set to a transformation according to a rotation matrix and a translation vector
    inline Matrix4& InverseTransformation(const Matrix3 &rotation, const Vector3 &translation){
        return SetInverseTransformation(rotation, translation);
    }
    ...
    inline Matrix4& Transform(const Matrix4 &matrix, Matrix4 & result) const{
        ...
        result._[0*4+0] = _[0*4+0] * matrix._[0*4+0] + _[0*4+1] * matrix._[1*4+0] + _[0*4+2] * matrix._[2*4+0];
        result._[1*4+0] = _[1*4+0] * matrix._[0*4+0] + _[1*4+1] * matrix._[1*4+0] + _[1*4+2] * matrix._[2*4+0];
        result._[2*4+0] = _[2*4+0] * matrix._[0*4+0] + _[2*4+1] * matrix._[1*4+0] + _[2*4+2] * matrix._[2*4+0];

        result._[0*4+1] = _[0*4+0] * matrix._[0*4+1] + _[0*4+1] * matrix._[1*4+1] + _[0*4+2] * matrix._[2*4+1];
        result._[1*4+1] = _[1*4+0] * matrix._[0*4+1] + _[1*4+1] * matrix._[1*4+1] + _[1*4+2] * matrix._[2*4+1];
        result._[2*4+1] = _[2*4+0] * matrix._[0*4+1] + _[2*4+1] * matrix._[1*4+1] + _[2*4+2] * matrix._[2*4+1];

        result._[0*4+2] = _[0*4+0] * matrix._[0*4+2] + _[0*4+1] * matrix._[1*4+2] + _[0*4+2] * matrix._[2*4+2];
        result._[1*4+2] = _[1*4+0] * matrix._[0*4+2] + _[1*4+1] * matrix._[1*4+2] + _[1*4+2] * matrix._[2*4+2];
        result._[2*4+2] = _[2*4+0] * matrix._[0*4+2] + _[2*4+1] * matrix._[1*4+2] + _[2*4+2] * matrix._[2*4+2];

        result._[0*4+3] = _[0*4+0] * matrix._[0*4+3] + _[0*4+1] * matrix._[1*4+3] + _[0*4+2] * matrix._[2*4+3] + _[0*4+3];
        result._[1*4+3] = _[1*4+0] * matrix._[0*4+3] + _[1*4+1] * matrix._[1*4+3] + _[1*4+2] * matrix._[2*4+3] + _[1*4+3];
        result._[2*4+3] = _[2*4+0] * matrix._[0*4+3] + _[2*4+1] * matrix._[1*4+3] + _[2*4+2] * matrix._[2*4+3] + _[2*4+3];

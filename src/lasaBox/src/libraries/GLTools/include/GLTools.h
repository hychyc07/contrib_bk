...
/**
 *
\defgroup icub_GLTools GLTools
@ingroup icub_lasaBox_libraries

A library mostly for OpenGL 3D object rendering.
...
This file can be edited at $ICUB_ROOT/contrib/src/lasaBox/src/libraries/GLTools
**/

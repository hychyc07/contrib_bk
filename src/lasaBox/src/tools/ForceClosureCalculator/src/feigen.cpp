...
static int norm_2       /* normalize eigenvectors to have two norm 1 .*/
                  (int     n,       /* Dimension of matrix ...........*/
                   REAL *  v[],     /* Matrix with eigenvektors ......*/
                   REAL    wi[]     /* Imaginary parts of evalues ....*/
                  )
/*====================================================================*
 *                                                                    *
 *  norm_2 normalizes the two norm of the column vectors in v.        *
 *  (special attention to complex vectors in v  is given)             *
 *                                                                    *
 *====================================================================*
 *                                                                    *
  ...
  for (j = 0; j < n; j++)
  {
    ...
    else
    {
       ...
       for (i = 1; i < n; i++)
       {
         tr = v[0][j];
         ti = v[0][j+1];
         norm+=comabs(tr,ti)*comabs(tr,ti);
       }
       for (i = 1; i < n; i++)
       {
           v[i][j]/= norm;
